...
namespace _460ASServicios
{
    public class Usuario_460AS
    {
        ...
        public string Rol_460AS { get; set; }
        ...
        public Usuario_460AS(string dni_460AS, string nombre_460AS, string apellido_460AS, string login_460AS, string password_460AS, string rol_460AS, int telefono_460AS, bool bloqueado_460AS, bool activo_460AS, int Contador_460AS, DateTime ultimoIntento_460AS)
        {
            DNI_460AS = dni_460AS;
