...
namespace _460ASBLL
{
    public class BLL460AS_Cliente
    {
        ...
        public void GuardarCliente_460AS(Cliente_460AS cliente)
        {
            ...
            var ev = Evento_460AS.GenerarEvento_460AS(ultimo, 2, "Clientes", $"Alta de cliente DNI={cliente.DNI_460AS}"
        );
        ...
        public void ActualizarCliente_460AS(Cliente_460AS cliente)
        {
            ...
            var ultimo = _eventoBLL.ObtenerUltimo_460AS();
            var ev = Evento_460AS.GenerarEvento_460AS(ultimo, 2, "Clientes",$"Modificación de cliente DNI={cliente.DNI_460AS}");
            _eventoBLL.GuardarEvento_460AS(ev);
        }
        ...
        public void EliminarCliente(string dni)
        {
            ...
            var ultimo = _eventoBLL.ObtenerUltimo_460AS();
            var ev = Evento_460AS.GenerarEvento_460AS(ultimo, 3, "Clientes", $"Baja de cliente DNI={dni}");
            _eventoBLL.GuardarEvento_460AS(ev);
        }
    }
}
